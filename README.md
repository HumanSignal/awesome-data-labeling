...
* [Universal Data Tool](https://universaldatatool.com/) - Configure and label images, text, audio or documents in an easy web interface with real-time team collaboration
