...
* [Doccano](https://github.com/doccano/doccano) - doccano is an open source text annotation tool which provides annotation features for text classification, sequence labeling and sequence to sequence tasks
